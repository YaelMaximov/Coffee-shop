...
export default function PaymentPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const orderResponse = await fetch('http://localhost:3010/order/save', {
        method: 'POST',
        headers: {
      ...
      if (orderResponse.ok) {
        ...
        const orderDishesResponse = await fetch('http://localhost:3010/order/saveDishes', {
          method: 'POST',
          headers: {
            'Content-Type': 'application/json',
          },
        ...
        if (order.orderType === 'delivery') {
          const deliveryResponse = await fetch('http://localhost:3010/order/saveDelivery', {
            method: 'POST',
            headers: {
              'Content-Type': 'application/json',
            },
          ...
          const pickupResponse = await fetch('http://localhost:3010/order/savePickup', {
            method: 'POST',
            headers: {
              'Content-Type': 'application/json',
            },
